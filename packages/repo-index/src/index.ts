...
import type { BuildOptions, Lang, RepoIndex, SymbolInfo, Edge } from "./types.js"
...
export function parserMode(): "native" | "fallback" {
  const require = createRequire(import.meta.url)
  try {
